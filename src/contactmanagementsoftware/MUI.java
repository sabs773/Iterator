...
public class MUI extends javax.swing.JFrame implements AcquaintanceIterator{
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        //choose from lists of file window
        JFileChooser fileChooser = new JFileChooser();
        //file path
        fileChooser.setCurrentDirectory(new File(System.getProperty("user.dir")));
        int result = fileChooser.showOpenDialog(this);
        //user chooses the file and then opens the file
        if (result == JFileChooser.APPROVE_OPTION) {
            File selectedFile = fileChooser.getSelectedFile();
            try {
                //cast 2d array to temp
                temp = (ArrayList<ArrayList<Acquaintances>>) SerializationUtil.deserialize(selectedFile);
                JOptionPane.showMessageDialog(this, "File Found "+selectedFile);
